...
<%
	...
	/*
		request 객체에서 요청 파라미터(폼전송 혹은 GET 방식 전송)를 읽어낼때는 
		.getParameter() 메소드를 이용한다.
		.getAttrubute() 메소드를 사용하는 실수들을 많이 합니다... 
		주의 바랍니당~~
	*/
	String nick=request.getParameter("nick");
	
	//이번에는 응답하고 나서 페이지 이동을 해도 읽어낼수 있도록 HttpSession 객체에 저장을 한다.
...
<body>
	...
	<p> 60 초 동안 아무런 요청을 하지않거나 웹브라우저를 닫으면 자동 삭제 됩니다.</p>
